...
const List = () => {
  ...
  <Table sx={{ minWidth: 650 }} aria-label="simple table">
    <TableHead>
      ...
      <TableCell className="tableCell">Make Coordinator</TableCell>
    ...
    <TableBody>
      {rows.map((row) => (
        ...
        >
          ...
          <TableCell className="tableCell">{row.contactno}</TableCell>
          <TableCell className="tableCell">{row.coordinator}</TableCell>
        </TableRow>
      ))}
    </TableBody>
  </Table>
